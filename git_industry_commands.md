...
**syntax:**
git commit
## purpose:Creates a new commit with the staged changes.Opens the default text editor to write a commit message.
**screenshot:**
...
## purpose:Creates a commit with a message directly from the command line (without opening editor).This is the most commonly used commit command in industry.
**screenshot:**
...
**syntax:**
git commit --amend 
## purpose:Modifies the most recent commit.Add missed fil correct small mistakes
**screenshot:**
...
## purpose:Amends the previous commit without changing the existing commit message.Useful when you forgot to add a file but message is correct.
**screenshot:**
...
## purpose:Deletes a local branch safely.Git only deletes the branch if it has already been merged into the current branch.
**screenshot:**
...
**syntax:**
git branch -D branch-name
## purpose:Force deletes a branch even if it has not been merged.Used when you want to remove a branch without checking merge status.
**screenshot:**
...
## purpose:switches between branches.This is a newer and simpler alternative to git checkout for branch switching.
**screenshot:**
...
## purpose:Creates a new branch and switches to it.It is the modern replacement for git checkout -b.
**screenshot:**
...
**syntax:**
git tag
## purpose:Lists all tags available in the repository.
**screenshot:**
...
**syntax:**
git submodule init
## purpose:Initializes the submodule configuration in the local repository.
**screenshot:**
...
## purpose:Downloads the submodule content and checks out the commit specified in the main repository.
**screenshot:**
